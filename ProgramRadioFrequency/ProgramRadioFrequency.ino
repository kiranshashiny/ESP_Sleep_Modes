...
// This is for ESP8266/ESP32 and the processor communicates to the
...
// Connect the SDA and SCL to appropriate pins on the I2C pins on ESPxxxx
...
{ 
  ...
  WiFi.begin("NETGEAR84", "welcome2ibm" );
...
void loop()
{
  ...
  /*for (int i=0; i<12; i++ ){
    ...
    radio.setFrequency(str[i]); // pick your own frequency
